                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <c:forEach items="${data}" var="u">
                                                <tr>
                                                    ...
                                                    <td>@mdo</td>
                                                    <td>
                                                        <a class="btn btn-primary" href="${pageContext.request.contextPath }/myAdmin/goodsEditShow?id=${g.id}&pageNo=${p.pageNo}&type=${type}">修改</a>
                                                        <a class="btn btn-primary" href="${pageContext.request.contextPath }/myAdmin/goodsDelete?id=${g.id}&pageNo=${p.pageNo}&type=${type}">删除</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
